...
class _MyContentsManageState extends State<MyContentsManage> {
  ...
  void _showDeleteConfirmationDialog(
      BuildContext context, String uid, String cid, String cname) {
    showDialog(
      context: context,
          ...
          children: <Widget>[
            Expanded(
              child: RefreshIndicator(
                ...
                child:
                contents.length > 0 ?ListView.builder(
                          ...
                          trailing: IconButton(
                            ...
                            onPressed: () {
                              ...
                              _showDeleteConfirmationDialog(context, uid!,
                                  contents[index].cid, contents[index].cname);
                            },
                          ),
                          onTap: () {
                            Navigator.push(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.push(context,
                    MaterialPageRoute(builder: (context) => CreateMyContents()))
